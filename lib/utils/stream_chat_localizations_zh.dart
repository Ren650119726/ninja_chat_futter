...
class StreamChatLocalizationsZh extends GlobalStreamChatLocalizations {
  ...
  static const delegate = _ZhStreamChatLocalizationsDelegate();
...
class _ZhStreamChatLocalizationsDelegate
    extends LocalizationsDelegate<StreamChatLocalizations> {
  const _ZhStreamChatLocalizationsDelegate();
  ...
  Future<StreamChatLocalizations> load(Locale locale) =>
      SynchronousFuture(const StreamChatLocalizationsZh());

  @override
  bool shouldReload(_ZhStreamChatLocalizationsDelegate old) => false;
}