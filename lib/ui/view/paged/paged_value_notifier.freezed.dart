...
mixin _$PagedValue<Key, Value> {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(List<Value> items, Key? nextPageKey, Exception? error)
        $default, {
...
abstract class _$$SuccessImplCopyWith<Key, Value, $Res> {
  ...
  @useResult
  $Res call({List<Value> items, Key? nextPageKey, Exception? error});
}
...
abstract class Success<Key, Value> extends PagedValue<Key, Value> {
  const factory Success(
      ...
      final Key? nextPageKey,
      final Exception? error}) = _$SuccessImpl<Key, Value>;
...
abstract class Error<Key, Value> extends PagedValue<Key, Value> {
  const factory Error(final Exception error) = _$ErrorImpl<Key, Value>;
